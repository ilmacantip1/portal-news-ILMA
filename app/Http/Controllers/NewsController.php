...
class NewsController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/news')->with('success', 'Data berita berhasil di tambahkan');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('/news')->with('success', 'Data berita berhasil di update');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect('/news')->with('success', 'Data berita berhasil di delete');
    }
